...
public static class SimpleTests {
	...
	private static string text = "Index_0 Index_1 Index_3 Index_4";
	...
	public static void TestBaseFunctionality() {
		...
		Log(text.Stylize().Red.Yellow.Size(24).Green.Blue.Purple.Orange,
		...
		Log("If you have a long string and you only need to add style to one or a few words in it, " +
...
#line hidden
	...
	private static void Log(object self, string description = null) {
		...
		string AddSpaces()      => _addPreceedingSpaces ? "                                                                                    " : "";
