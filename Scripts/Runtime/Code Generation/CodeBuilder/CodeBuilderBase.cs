...
public class CodeBuilderBase {
	...
	protected CodeBuilderBase(CodeBuilderInfo root) => Root = root;
...
/// <summary>
/// This class exists to allow contained methods to directly return provided type T,
/// which allows anyone who implements this class to be able to use the FluentAPI without
/// the need of constant cast to their type.
/// </summary>
