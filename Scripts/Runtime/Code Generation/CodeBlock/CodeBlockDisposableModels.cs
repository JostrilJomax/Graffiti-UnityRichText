...
public class MethodDBlock : CodeBlockBaseDisposable<MethodDBlock> {

    public readonly (string type, string name)[] Params;

    public MethodDBlock(CodeBuilderInfo root, string returns, string name, [CanBeNull] (string type, string name)[] params_)
            : base(
...
public class EnumBlock : CodeBlockBaseDisposable<EnumBlock> {
...
public class SwitchBlock : CodeBlockBaseDisposable<SwitchBlock> {
...
public class CodeBlock : CodeBlockBaseDisposable<CodeBlock> {
