...
// Creation time: 2022-08-25 20:24:05
// If you want to make any permanent changes, go to the class StylizationOptionsGenerator
// At: ???
//--------------------------------------------------------------------------------------
...
namespace Graffiti {
    ...
    [PublicAPI] 
    public interface IOnlyColor<out T> {
        public T White  { get; }
        public T Grey   { get; }
        public T Black  { get; }
        public T Red    { get; }
