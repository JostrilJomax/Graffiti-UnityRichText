...
public partial class StyledString {
	...
	/// <summary>
	/// • This indexer allows you to <b>add style directly to modifier character</b> (see <see cref="ModifierCharacterSet"/>).
	/// <br/>It means you can add <i>Color/Gradient/etc.</i> to <i>Underline/Strikethrough/etc.</i>
	/// <para/>
	...
	///
	/// <i><b>Incorrect usage:</b></i> (will make your text Gradient from Blue to Yellow and with regular Underline)
	/// <code> "Some Cool Text".Stylize().Underline.Blue[Style.Yellow]; </code>
	/// </example>
	///
	/// <remarks> • Example of indexer usage (text with Yellow Underline):
	/// <br/>"Some Cool Text".Stylize().Underline[Style.Yellow]; </remarks>
...
public partial class StringStyle {
	...
	/// <inheritdoc cref="StyledString.this[StringStyleCore]"/>
	/// <remarks> • Example of indexer usage (Yellow Underline style):
	/// <br/>var myStyle = Style.Underline[Style.Yellow]; </remarks>
