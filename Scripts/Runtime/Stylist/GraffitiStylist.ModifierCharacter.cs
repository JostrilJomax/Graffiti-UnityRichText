...
internal static partial class GraffitiStylist {
    ...
    internal static class ModifierCharacter {
        ...
        internal static char GetModifierCharacter(ModifierCharacterType modifierType)
            => modifierType switch {
            ...
            char[] ignoredSymbols)
        {
            ...
            AppendGradient(
                self, scope.between, gradient, modifierPair,
            ...
            char[] ignoredSymbols)
        {
            ...
            for (int i = 0; i < chars.Length; i++) {
                ...
                foreach ((char[] chars, Gradient gradient) pair in modifierPairs)
                    Add(
                        tempChars,
                        pair.gradient != null
