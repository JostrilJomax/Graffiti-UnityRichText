...
internal static partial class GraffitiStylist {
    ...
    internal static class AddTag {
        ...
        {
            switch (fontStyle) {
                case UnityBuildInFontStyleType.Bold:
                    Bold(sb, startIndex, endIndex);
                    return;
                case UnityBuildInFontStyleType.Italic:
                    Italic(sb, startIndex, endIndex);
                    return;
                case UnityBuildInFontStyleType.BoldItalic:
                    BoldItalic(sb, startIndex, endIndex);
                    return;
            }
        }
        ...
        [Pure] public static string Bold(string self) => $"<b>{self}</b>";

        /// <summary> Makes your text <i> Italic </i> </summary>
        [Pure] public static string Italic(string self) => $"<i>{self}</i>";
        ...
        ///     </b>
        /// </summary>
        [Pure] public static string BoldItalic(string self) => $"<b><i>{self}</i></b>";

        /// <summary> Set text size </summary>
        /// <param name="value"> default value is 12 (in unity console) </param>
        [Pure] public static string Size(string self, int value) => $"<size={value}>{self}</size>";

        /// <summary> Adds color to your text </summary>
        /// <param name="color">
        ///     Must starts with "#" (if hexadecimal) or be a built-in color name <see cref="UnityColors"/>
        /// </param>
        [Pure] public static string Color(string self, string color) => $"<color={color}>{self}</color>";

        /// <summary>
        ///     <para> Creates code link to <b> line </b> of code in <b> file </b> with <b> header </b>. </para>
        /// </summary>
        /// <param name="header">
        ///     A string that will be displayed in console as an underlined blue link (color can be changed). On
        ///     click will open defined <b> file </b> in defined <b> line </b> in your default text editor.
        /// </param>
        ...
        [Pure] public static string CodeLink(string header, string file, string line) => $"<a href=\"{file}\" line=\"{line}\">{header}</a>";
        ...
        /// <summary> Adds color to your text </summary>
        /// <param name="color">
        ///     Must starts with "#" (if hexadecimal) or be a built-in color name see <see cref="UnityColors"/>
        ///     for built-in colors
        /// </param>
        ...
        /// <summary> Makes your text <b> Bold </b> </summary>
        [Pure] public static char[] Bold(char self) => Bold(new[] { self });

        /// <summary> Makes your text <i> Italic </i> </summary>
        [Pure] public static char[] Italic(char self) => Italic(new[] { self });
        ...
        ///     </b>
        /// </summary>
        [Pure] public static char[] BoldItalic(char self) => BoldItalic(new[] { self });

        /// <summary> Set text size </summary>
        /// <param name="value"> default value is 12 (in unity console) </param>
        [Pure] public static char[] Size(char self, int value) => Size(new[] { self }, value);

        /// <summary> Adds color to your text </summary>
        /// <param name="color">
        ///     Must starts with "#" (if hexadecimal) or be a built-in color name <see cref="UnityColors"/>
        /// </param>
        [Pure] public static char[] Color(char self, string color) => Color(new[] { self }, color);
        ...
        /// <summary> Makes your text <b> Bold </b> </summary>
        [Pure] public static char[] Bold([NotNull] char[] self) => FillSelfWith(self, START_BOLD, CLOSE_BOLD);

        /// <summary> Makes your text <i> Italic </i> </summary>
        [Pure] public static char[] Italic([NotNull] char[] self) => FillSelfWith(self, START_ITALIC, CLOSE_ITALIC);
        ...
        ///     </b>
        /// </summary>
        [Pure] public static char[] BoldItalic([NotNull] char[] self) => FillSelfWith(self, START_BOLDITALIC, CLOSE_BOLDITALIC);
