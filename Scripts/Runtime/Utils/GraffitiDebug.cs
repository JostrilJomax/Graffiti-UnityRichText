...
/// <remarks>
/// All logging methods are with [Conditional] attribute. That means you can easily enable/disable
/// debugging without any loose in performance or time.
/// <br/><b>To enable/disable</b> debugging you need to add/remove the appropriate <see cref="ENABLE_LOGGING"/> in Unity's Project Settings.
/// <br/><b>Full path:</b> Edit/Project Settings/Player/Other Settings/Script Compilation
/// </remarks>
...
#line hidden
	...
	[Conditional(ENABLE_LOGGING)] internal static void Assert(bool condition, string message) { if (condition) Debug.Log(FormatLog(message)); }
