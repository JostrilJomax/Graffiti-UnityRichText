...
internal class ModifierCharacter {
    ...
    ///     <para/>
    ///     So, for example, in this method bold/italic is not applied to the modifier character, which means that the modifier
    ///     character can't be Bold or Italic. But this method contains the application of a size and color modifiers, which
    ///     means that size and color of the modifier character can be set.
    ///     <para/>
